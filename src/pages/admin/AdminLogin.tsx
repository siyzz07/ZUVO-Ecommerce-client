            ...
            <div className="hidden lg:flex lg:w-[45%] relative bg-zinc-900 overflow-hidden">
                ...
                <div className="relative z-10 p-16 flex flex-col justify-between w-full h-full">
                    ...
                    <div className="max-w-md">
                        ...
                        >
                            Manage your <br /> <span className="text-brand-primary">Store.</span>
                        </motion.h1>
                        <p className="text-zinc-400 font-medium text-lg leading-relaxed">
                            Access your administrative dashboard to manage inventory, track sales, and customize your retail presence.
                        </p>
                    </div>

                    <div className="flex items-center gap-8 text-zinc-500 font-bold text-[10px] uppercase tracking-[0.2em]">
                        <span className="flex items-center gap-2 underline underline-offset-4"><Globe size={14} /> Global Hub</span>
                        <span className="flex items-center gap-2"><Zap size={14} /> Ultra Fast</span>
                    </div>
                </div>
                ...
                >
                    <div className="flex justify-between items-start mb-10">
                        <div className="space-y-2">
                            <h2 className="text-3xl font-extrabold tracking-tight text-zinc-900 dark:text-white">Admin Login</h2>
                            <p className="text-zinc-500 dark:text-zinc-400 font-medium text-sm">Welcome back! Please enter your details.</p>
                        </div>
                        <ThemeToggle />
                    </div>
                    ...
                    <form onSubmit={handleLogin} className="space-y-5">
                        <div className="space-y-2">
                            <label className="text-[10px] font-bold uppercase tracking-widest text-zinc-400 ml-1 italic">Email Address</label>
                            <div className="relative group">
                                <Mail className="absolute left-4 top-1/2 -translate-y-1/2 text-zinc-300 group-focus-within:text-brand-primary transition-colors" size={16} />
                                <input 
                                    type="email" 
                                    required
                                    value={email}
                        ...
                        <div className="space-y-2">
                            <label className="text-[10px] font-bold uppercase tracking-widest text-zinc-400 ml-1 italic">Password</label>
                            <div className="relative group">
                                <Lock className="absolute left-4 top-1/2 -translate-y-1/2 text-zinc-300 group-focus-within:text-brand-primary transition-colors" size={16} />
                                <input 
                                    type="password" 
                                    required
                                    value={password}

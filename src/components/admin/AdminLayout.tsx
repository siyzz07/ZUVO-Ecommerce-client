            ...
            <aside className="hidden lg:flex w-64 border-r border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 flex-col p-6 fixed h-full z-40">
                ...
                <div className="pt-6 border-t border-zinc-100 dark:border-zinc-800">
                    ...
                    <div className="flex gap-2">
                        <ThemeToggle />
                        <button onClick={handleLogout} className="flex-1 flex items-center justify-center gap-2 py-2.5 rounded-xl font-bold text-xs text-red-500 bg-red-50 dark:bg-red-900/20 hover:bg-red-100 dark:hover:bg-red-900/40 transition-all">
                ...
                {isMobileMenuOpen && (
                    ...
                    >
                        ...
                        <div className="pt-6 border-t border-zinc-100 dark:border-zinc-800">
                            ...
                            <button onClick={handleLogout} className="w-full py-4 rounded-2xl font-bold text-red-500 bg-red-50 dark:bg-red-500/10 border border-red-100 dark:border-red-500/20 active:scale-95 transition-all">
